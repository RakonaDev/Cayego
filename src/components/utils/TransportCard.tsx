...
export default function TransportCard({ transport }: { transport: SpaceInterface }) {
  return (
    <div className="max-w-[950px] w-full min-w-[250px] flex gap-5 lg:flex-row flex-col max-lg:items-center">
      <div className="w-1/2">
        <Image 
          src={ transport.url }
          width={450}
      ...
      <div className="w-1/2 h-full flex flex-col justify-center space-y-5">
