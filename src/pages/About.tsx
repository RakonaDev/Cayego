      ...
      <main className='w-full py-10 bg-gray-100'>
        <Container>
          ...
          <article className='w-full flex flex-col lg:flex-row gap-10'>
            ...
            <div className='w-full lg:w-1/2 space-y-6'>
              <h2 className='text-center font-bold text-3xl font-Montserrat'>Visión</h2>
              <p className='lg:text-start text-center text-lg'>Ser la empresa líder en soluciones de movilidad, reconocida por ofrecer un servicio de traslado excepcional, innovador y sostenible, que supere las expectativas de nuestros clientes y contribuya a mejorar la calidad de vida de las personas.</p>
              <Image
                src={Vision}
                width={500}
                height={500}
